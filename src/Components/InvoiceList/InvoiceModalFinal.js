...
export default function InvoiceModalFinal({
  list: projects,
  handleEditBill,
  handleReFetch,
  createInvoice,
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (level, record) => (
        <div className="font-[500] cursor-pointer font-montserrat  text-[13px]">
          ...
          <Tag color="blue"><p>{Math.round(record.unit*100)/100}</p></Tag>
    ...
    },
    {
      ...
      render: (level, record) => (
        <div className="font-[500] cursor-pointer font-montserrat text-[13px]">
          <Tag color="geekblue"><p>{Math.round(record.unit_rate*100)/100}</p></Tag>
        </div>
      ),
    },
    {
      ...
      render: (level, record) => (
        <div className=" font-[500] cursor-pointer font-montserrat ">
          <Tag color="red"><p>{Math.round(record.vat*100)/100}%</p></Tag>
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (level, record) => (
        <div className="font-[600] cursor-pointer font-montserrat text-[13px]">
          <p>{(Math.round(record.total_amount*100)/100).toLocaleString()}</p>
        </div>
      ),
    },
    {
        ...
        <div className="cursor-pointer font-montserrat font-[400] text-[13px]">
          {
            ...
            <div className="flex gap-3">
              <span className="flex flex-wrap gap-2">
                ...
                <Button onClick={() => handleEditBill(record.id)}>
                  Edit
                </Button>
